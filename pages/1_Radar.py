...
def main():
    ...
    # 🚦 LÓGICA DO GRÁFICO SEMÁFORO DE TRÊS CORES BASEADO NO PRODUTO SELECIONADO
    if posicao_lista in:
    ...
    with col_direita:
        ...
        # 🪐 AMARRAÇÃO INLINE V38 DEF: Valores gerados e indexados de forma 100% fechada na mesma linha!
