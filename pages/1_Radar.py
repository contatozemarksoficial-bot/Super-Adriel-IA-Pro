...
def main():
    ...
    st.info("🛰️ System operando com Inteligência Preditiva Computacional. Auditoria ativa às " + horario_viva)
    st.markdown("---")
    ...
    with col_esquerda:
        ...
        # RENDERIZAÇÃO EM LOOP EXPURGANDO COMPONENTES CINZAS DA TELA
    ...
    with col_direita:
        ...
        # Engenharia Linear Pura: Os dados numéricos do gráfico foram incorporados diretamente de forma compactada e lacrada!
