...
def main():
    ...
    # 🔥 BLINDAGEM TOTAL DA LINHA 25: Corrigido o erro de indentação solto e amarrado na string de estilo
    ...
    lista_completa_produtos = [
        ...
        {"id": "Cortexi", "label": "🛡️ Cortexi | 🔵 NORMAL - ESTÁVEL", "usa": "$1.50", "uk": "$0.95", "ca": "$1.15", "au": "$1.05", "nz": "$0.90", "buscas": "28.300", "cliques": "620", "status_semaforo": "🔵 SINAL AZUL: ESCALA REGULAR - LEILÃO LIVRE E TRANQUILO", "cor_semaforo": "#0066ff", "dor": "Idosos sofrendo de zumbido no ouvido (tinnitus) constante, o que atrapalha o sleep, tira o foco diário e gera ansiedade profunda.", "veredito": "Use termos focados no alívio de sintomas auditivos. Excelente ROI em campanhas de Bing Search pelo CPC reduzido."},
