...
def main():
    # 1. CONFIGURAÇÃO (Sidebar visível e Design Luxo)
    ...
    p_lista = [
        {"n": "ZenCortex", "e": "Google Ads (Fundo)", "d": "Zumbido e névoa mental pós-40.", "v": "USA", "s": "JUN/2026", "b": [90,85,70,60,110,120,115,50,85,65,80,95]},
        {"n": "FitSpresso", "e": "Facebook Ads (VSL)", "d": "Bloqueio metabólico matinal.", "v": "Canadá", "s": "ALTA ESCALA", "b": [60,105,80,85,80,115,95,50,120,60,70,85]},
        {"n": "Nagano Tonic", "e": "Native Ads", "d": "Gordura visceral e baixa energia.", "v": "Austrália", "s": "MAIO/2026", "b": [75,80,125,52,45,85,91,88,68,118,102,93]},
        {"n": "Sugar Defender", "e": "Google Ads (Review)", "d": "Picos de insulina e fadiga.", "v": "USA", "s": "TOP VENDAS", "b": [85,90,110,65,70,95,100,55,75,80,90,105]},
        {"n": "DentiCore", "e": "YouTube Ads", "d": "Saúde oral e reconstrução.", "v": "Irlanda", "s": "RECENTE", "b": [50,60,75,90,110,120,105,80,95,100,85,70]},
