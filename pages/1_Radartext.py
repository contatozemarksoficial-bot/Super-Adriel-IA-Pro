...
/* ⛏️ BOTÃO MESTRE DE DISPARO DA VARREDURA NO TOPO */
.stButton > button {
...
# BANCO DE DADOS INTEGRADO DA GRINGA REAL (20 PRODUTOS CONFIRMADOS)
produtos_gringos = {
    ...
    "Alpilean": {"col": "T10", "sym": "🔥", "status": "ALVO DE GUERRA", "cor": "#ef4444", "p": "ClickBank", "pais": "EUA / CA", "motivo": "Fórmula de temperatura interna celular. Movimentação ativa de buscas.", "base": 38000},
    "Liv Pure": {"col": "T10", "sym": "📈", "status": "ALVO DE GUERRA", "cor": "#ef4444", "p": "ClickBank", "pais": "EUA / UK", "motivo": "Foco na saúde do fígado. Volume de pesquisa constante gringo.", "base": 45000},
...
if st.session_state.executou_scan:
    ...
    <div class="terminal-cyber">
        ...
        🛒 [MERCADO] Varrendo bases de dados da ClickBank, Digistore24, BuyGoods e MaxWeb para: <b>{p_selecionado}</b>...<br>
