...
with c_topo1:
    ...
    <div style='background: linear-gradient(135deg, #0f172a 0%, #070a13 100%); border: 1px solid #1f293b; padding: 15px; border-radius: 12px; text-align: center;'>
        <span style='font-size:11px; font-weight:800; color:#64748b; text-transform:uppercase; letter-spacing:1px;'>Alvo em Foco Oculto</span><br>
...
if st.session_state.executou_scan:
    ...
    <div class="terminal-cyber">
        ...
        ✅ [VERIFICADO] Resultados consolidados com precisão absoluta.
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown(f'<h3 style="color:#00ffcc; font-weight:900; margin-bottom:15px;">🎯 Resultado da Pesquisa: <span style="color:#ffffff;">{p_selecionado}</span></h3>', unsafe_allow_html=True)
