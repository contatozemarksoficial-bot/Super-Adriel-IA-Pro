...
# BANCO DE DADOS COMPLETO COM CORREÇÃO TÉCNICA NA SINTAXE DE PONTUAÇÃO
produtos_gringos = {
...
with col_central_dir:
    ...
    # Exibe os blocos numéricos exatamente como eram no seu modelo original
    ...
    # 🟢 GRÁFICO EM COLUNAS CIANO INTERATIVO E FLUTUANTE
