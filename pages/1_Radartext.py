...
/* Remove completamente fundos brancos ou bordas fantasmas de toda a tela */
...
div.stButton > button:hover { transform: translateY(-2px) !important; box-shadow: 0 0 35px rgba(0, 255, 135, 0.7) !important; }
</style>
...
# 🚨 SELEÇÃO DO PRODUTO POR CAIXA NATIVA (IMUNE A CRASHES NO PYTHON 3.14)
lista_nomes_produtos = list(produtos_gringos.keys())
p_selecionado = st.selectbox("🎯 Escolha o Produto Gringo Valeriano para Análise:", lista_nomes_produtos, index=0)

st.write("")
disparar_scan = st.button("⛏️ EXECUTAR VARREDURA DA INTELIGÊNCIA CENTRAL", use_container_width=True)
st.write("---")

# EXECUTOR DE DADOS REALTIME
if disparar_scan:
