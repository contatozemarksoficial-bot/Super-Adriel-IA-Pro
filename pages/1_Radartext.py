...
# Inicialização segura das variáveis de memória para o painel não sumir no clique
...
# BANCO DE DADOS INTEGRADO DA GRINGA REAL EM DUAS COLUNAS LARGAS
produtos_gringos = {
...
# PAINEL DE CONTROLE DO TOPO NATIVO
...
# EXECUÇÃO OPERACIONAL DA API RE REALIZADA NO CLIQUE DO BOTÃO DO TOPO
if st.session_state.executou_scan:
    ...
    # Gráfico em colunas verticais puras sem erros de recuo ou aspas
...
# =============================================================================================================
# 🚨 ESTRUTURA OFICIAL: APENAS 2 COLUNAS LARGAS DE LUXO FIXADAS NO RODAPÉ VIA BOTÕES NATIVOS SEGUROS
# =============================================================================================================
st.write("---")
with st.container():
